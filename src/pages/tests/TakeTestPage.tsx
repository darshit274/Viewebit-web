  ...
  const handleSubmitQuiz = async () => {
    ...
    try {
      ...
      console.log('Submitting quiz to backend...', {
        testId: uuid,
        answers: answers,
        totalTimeSpent: Math.max(0, (quizData?.questions.length || 0) * 90 - timeRemaining)
      });

      // Use the simple quiz submission API
      const submitResponse = await api.post(`/quiz/submit`, {
        userId: localStorage.getItem('mocktail_user') ? JSON.parse(localStorage.getItem('mocktail_user')!).uuid : `quiz-user-${Date.now()}`,
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            {quizData.questions.map((question, index) => {
              ...
              return (
                <div key={question.uuid} className="border-b border-gray-100 pb-4 last:border-b-0">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h4 className="font-semibold text-gray-800 mb-4">Quiz Progress</h4>
                ...
                <div className="mb-6">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div 
                      ...
                      style={{
                        width: `${(Object.keys(selectedAnswers).length / quizData.questions.length) * 100}%`
                      }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="flex space-x-3">
                  ...
                  >
                    ...
                    {isSubmitting ? 'Submitting...' : `Submit Quiz (${Object.keys(selectedAnswers).length}/${quizData.questions.length})`}
                  </button>
                </div>
              </div>
            </div>
