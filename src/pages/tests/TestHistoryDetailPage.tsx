      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Error loading result</h3>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Test Results</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
          ...
          <div className="mb-6 pb-6 border-b border-gray-100">
            <h2 className="text-lg font-semibold text-gray-900 mb-2">{result.categoryName}</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-3 mb-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-center">
              <div className="text-xl sm:text-2xl font-bold text-blue-700">{result.totalQuestions}</div>
              <div className="text-xs sm:text-sm text-blue-600 font-medium">Total Questions</div>
            </div>

            {/* Attempted */}
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 text-center">
              <div className="text-xl sm:text-2xl font-bold text-purple-700">{result.attempted}</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
              ...
              <div className="text-2xl font-bold text-gray-700">{result.notAttempted}</div>
              <div className="text-sm text-gray-600 font-medium">Not Attempted</div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-lg font-bold text-gray-900">{result.totalMarks}</span>
                </div>
                {result.negativeMarks > 0 && (
                  <>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs text-gray-500">Marks Obtained:</span>
                      <span className="text-sm font-semibold text-gray-700">{result.obtainedMarks.toFixed(2)}</span>
                    </div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs text-amber-600">Negative Marks:</span>
                      <span className="text-sm font-semibold text-amber-600">-{result.negativeMarks.toFixed(2)}</span>
                    </div>
                  </>
                )}
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-gray-700">Final Score:</span>
                  <span className="text-xl font-bold text-blue-600">{result.finalScore.toFixed(2)}</span>
                </div>
              </div>
