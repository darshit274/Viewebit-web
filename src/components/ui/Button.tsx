  ...
  return (
    <button
      className={cn(
        ...
        {
          // Variants
          'bg-blue-600 text-white shadow-sm hover:bg-blue-700 focus:ring-blue-500 active:bg-blue-800':
            variant === 'primary',
          'bg-gray-100 text-gray-900 shadow-sm hover:bg-gray-200 focus:ring-gray-500 active:bg-gray-300':
            variant === 'secondary',
          'border border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-blue-500 active:bg-gray-100':
            variant === 'outline',
