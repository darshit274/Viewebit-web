  ...
  return (
    <button
      className={cn(
        ...
        {
          // Variants
          'bg-primary-600 text-white shadow-sm hover:bg-primary-700 focus:ring-primary-500 active:bg-primary-800':
            variant === 'primary',
          'bg-gray-100 text-gray-900 shadow-sm hover:bg-gray-200 focus:ring-gray-500 active:bg-gray-300':
            variant === 'secondary',
          'border border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-primary-500 active:bg-gray-100':
            variant === 'outline',
